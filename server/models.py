...
class Employee(db.Model):
    ...
    reviews = db.relationship('Review', back_populates="employee", cascades='all, delete-orphan')

    onboarding = db.relationship(
        'Onboarding', uselist=False, back_populates='employee', cascades='all, delete-orphan'
    )
